...
This do-file is the third of three for the first tax change. This file takes the 
datasets created in synth_preestimation and runs through a series of 
...
cd "`mypath'"
log using "`mypath_logs'synth_alcohol_postestimation_2000", replace
...
** Original Code - 1993, 1995, 1998

synth `a'_alcohol `vars1', ///
	trunit(17) trperiod(2000) ///
	xperiod(1992(1)1998) mspeperiod(1992(1)1998) ///
	resultsperiod(1992(1)2008) fig keep(original) replace
* graph export original.pdf, replace 


** Second set of lags - 1992, 1997
synth `a'_alcohol `vars2' ///
										`a'_alcohol(1992) `a'_alcohol(1997), ///
	trunit(17) trperiod(2000) xperiod(1992(1)1998) mspeperiod(1992(1)1998) ///
	resultsperiod(1992(1)2008) fig keep(lags_v2) replace
* graph export lags_v2.pdf, replace 


** Third set of lags - 1995, 1998
synth `a'_alcohol `vars2' ///
														`a'_alcohol(1995) `a'_alcohol(1998), ///
	trunit(17) trperiod(2000) xperiod(1992(1)1998) mspeperiod(1992(1)1998) ///
	resultsperiod(1992(1)2008) fig keep(lags_v3) replace
* graph export lags_v3.pdf, replace 

** Smooth lags using tssmooth

tssmooth ma `a'_alcohol_sm= `a'_alcohol, window (2 1 2)
synth `a'_alcohol `vars2' `a'_alcohol_sm(1993) `a'_alcohol_sm(1995) `a'_alcohol_sm(1998), ///
	trunit(17) trperiod(2000) xperiod(1992(1)1998) mspeperiod(1992(1)1998) ///
	resultsperiod(1992(1)2008) fig keep(lags_smooth) replace
...
synth `a'_alcohol `vars2' ///
	`a'_alcohol(1993) `a'_alcohol(1995) `a'_alcohol(1998), ///
	trunit(17) trperiod(2000) xperiod(1990(1)1998) mspeperiod(1990(1)1998) /// 
	resultsperiod(1990(1)2008) keep(90_98) replace

***1988-1998***
synth `a'_alcohol `vars2' ///
	`a'_alcohol(1991) `a'_alcohol(1995) `a'_alcohol(1998), ///
	trunit(17) trperiod(2000) xperiod(1988(1)1998) mspeperiod(1988(1)1998) ///
	resultsperiod(1988(1)2008) keep(88_98) replace


***1986-1998***
synth `a'_alcohol `vars2' ///
	`a'_alcohol(1989) `a'_alcohol(1995) `a'_alcohol(1998), ///
	trunit(17) trperiod(2000) xperiod(1986(1)1998) mspeperiod(1986(1)1998) ///
	resultsperiod(1986(1)2008) keep(86_98) replace

clear
foreach file in original 90_98 88_98 86_98 {
	use "`file'"
	drop if _time==.
	drop _Co_Number _W_Weight
	quietly: save "`file'_short", replace
...
cd "`mypath'"	
use "`mypath_data'donorstate_weights_2000.dta"
...
synth `a'_alcohol `vars1', ///
	trunit(17) trperiod(2000) xperiod(1992(1)1998) mspeperiod(1992(1)1998) ///
	resultsperiod(1992(1)2008) fig keep(no_`x') replace
