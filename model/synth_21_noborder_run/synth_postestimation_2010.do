...
cd "`mypath_nb'"
log using "`mypath_logs'synth_alcohol_postestimation_nb_21plus_2010", replace
...
synth `a'_alcohol ///
	...
	trunit(17) trperiod(2010) xperiod(2001(1)2008) mspeperiod(2001(1)2008) ///
	resultsperiod(2001(1)2015) keep(01_08) replace
...
synth `a'_alcohol ///
	...
	`a'_alcohol(2001) `a'_alcohol(2002) `a'_alcohol(2003) `a'_alcohol(2004) ///
	`a'_alcohol(2005) `a'_alcohol(2006) `a'_alcohol(2007) `a'_alcohol(2008), ///
	trunit(17) trperiod(2010) xperiod(1990(1)2008) mspeperiod(1990(1)2008) ///
	resultsperiod(1990(1)2015) keep(90_08) replace
...
synth `a'_alcohol `a'_alcohol(1988) `a'_alcohol(1989) ///
	...
	`a'_alcohol(2001) `a'_alcohol(2002) `a'_alcohol(2003) `a'_alcohol(2004) ///
	`a'_alcohol(2005) `a'_alcohol(2006) `a'_alcohol(2007) `a'_alcohol(2008), ///
	trunit(17) trperiod(2010) xperiod(1988(1)2008) mspeperiod(1988(1)2008) ///
	resultsperiod(1988(1)2015) keep(88_08) replace

***1986-2008***
synth `a'_alcohol `a'_alcohol(1986) `a'_alcohol(1987) `a'_alcohol(1988) ///
	 `a'_alcohol(1989) `a'_alcohol(1990) `a'_alcohol(1991) `a'_alcohol(1992) ///
	`a'_alcohol(1993) `a'_alcohol(1994) `a'_alcohol(1995) `a'_alcohol(1996) ///
	`a'_alcohol(1997) `a'_alcohol(1998) `a'_alcohol(1999) `a'_alcohol(2000) ///
	`a'_alcohol(2001) `a'_alcohol(2002) `a'_alcohol(2003) `a'_alcohol(2004) ///
	`a'_alcohol(2005) `a'_alcohol(2006) `a'_alcohol(2007) `a'_alcohol(2008), ///
	trunit(17) trperiod(2010) xperiod(1986(1)2008) mspeperiod(1986(1)2008) ///
	resultsperiod(1986(1)2015) keep(86_08) replace


clear
foreach file in all_lags 01_08 90_08 88_08 86_08 {
	use "`file'"
	drop if _time==.
...
export excel using "`mypath_nb'Analysis_`a'_`b'_2010.xlsx", sheet("Pre-Treatment Test - Data") sheetmodify  firstrow(var)
clear
...
use "`mypath_data'donorstate_weights_nb_21plus_2010.dta"
...
export excel using "`mypath_nb'Analysis_`a'_`b'_2010.xlsx", sheet("Leave-One-Out - Data") sheetmodify  firstrow(var)
clear
