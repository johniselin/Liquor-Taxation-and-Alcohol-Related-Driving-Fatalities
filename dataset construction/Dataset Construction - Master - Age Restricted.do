...
if regexm(c(os),"Mac") == 1 {
	local mypath_synth = "/Users/johniselin/Desktop/Desktop - John’s MacBook Pro/TPC/Illinois Alcohol Taxes and Drunk Driving/Results/Synth Run 01.05.2019/"
	}
	else if regexm(c(os),"Windows") == 1 local mypath_synth = ""
	

log using "`mypath'DatasetConstruction_21_Log.smcl", replace
cd "`mypath'"
...
do "Dataset Construction - FARS (21plus).do"
...
quietly: save "Dataset 21 Plus (1982-2015).dta", replace
...
quietly: save "Dataset US 21 Plus (1982-2015).dta", replace
clear
use "Dataset 21 Plus (1982-2015).dta", 
append using "Dataset US 21 Plus (1982-2015).dta"
quietly: save "Dataset 21 Plus (1982-2015).dta", replace
...
quietly: save "alcohol_21plus.dta", replace
quietly: save "`mypath_synth'alcohol_21plus.dta", replace
...
use "fars - no borders - 21 only - 1982-2015.dta", clear
sort statename year
merge 1:1 statename year using "Age Brackets 1982-2015.dta"
drop _merge
merge 1:1 statename year using "State Motor Fuel Tax 1982-2015.dta"
...
quietly: save "Dataset - no borders - 21 (1982-2015).dta", replace
...
quietly: save "alcohol_noborders_21plus.dta", replace
quietly: save "`mypath_synth'alcohol_noborders_21plus.dta", replace
*export excel "Dataset (1982-2015).xlsx", firstrow replace 
sum
de
...
quietly: save "Dataset - all borders - 21 plus - (1982-2015).dta", replace
...
quietly: save "alcohol_allborders_21plus.dta", replace
quietly: save "`mypath_synth'alcohol_allborders_21plus.dta", replace
*export excel "Dataset (1982-2015).xlsx", firstrow replace 
sum
de
