...
This do-file is the first of three for the first tax change. This file creates 
...
cd "`mypath'"
log using "`mypath_logs'synth_alcohol_preestimation_2000", replace
...
xtline `depvar'_alcohol if state == 0 & year < 1999 & year > 1991| state == 17 & year < 1999 & year > 1991, i(statename) t(year)  overlay 	///
	title ("Alcohol-Related Accidents per Driver, US and IL (1992-1998)")			///
	ytitle("Alcohol-Related Accidents per Driver") xsize(8)
