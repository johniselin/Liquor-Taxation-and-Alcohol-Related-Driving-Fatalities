...
* Edited to get BAC 0.1 instead of 0.08
...
* BAC over 0.1 data CHANGED
gen bac_limit = 1 if alc_res_2 > 10 & alc_res_2 < 95
...
quietly: save "`mypath_1'miper_person_1982-2015_bac01.dta", replace 
...
quietly: save "`mypath_1'Driving Fatalities Data BAC 01 1982-2015.dta", replace

quietly: save "`mypath'fars BAC 01 1982-2015.dta", replace
...
use "`mypath_1'miper_person_1982-2015_bac01.dta"
...
quietly: save "`mypath'fars - no borders - BAC 01 - 1982-2015.dta", replace
...
quietly: save "`mypath'fars - all borders - BAC 01 - 1982-2015.dta", replace
