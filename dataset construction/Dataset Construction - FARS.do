...
quietly: save "`mypath_1'miper_person_1982-2015.dta", replace 
...
quietly: save "`mypath_1'Driving Fatalities Data 1982-2015.dta", replace

quietly: save "`mypath'fars 1982-2015.dta", replace
...
use "`mypath_1'miper_person_1982-2015.dta"
...
quietly: save "`mypath'fars - no borders - 1982-2015.dta", replace
...
quietly: save "`mypath'fars - all borders - 1982-2015.dta", replace
