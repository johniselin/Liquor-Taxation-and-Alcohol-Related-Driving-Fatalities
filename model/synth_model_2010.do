...
cd "`mypath'"
log using "synth_alcohol_model_2010", replace
...
synth `a'_alcohol `a'_alcohol(1982) `a'_alcohol(1983) `a'_alcohol(1984) 	///
	...
	trunit(17) trperiod(2010) xperiod(1982(1)2008)  fig keep(all_lags) replace
...
foreach x of local states {
	synth `a'_alcohol `vars1', ///
	trunit(`x') trperiod(2010) xperiod(1982(1)2008)  keep(`x'placebo) replace
...
foreach x of local states {
	...
	`a'_alcohol(2001) `a'_alcohol(2002) `a'_alcohol(2003) `a'_alcohol(2004) ///
	`a'_alcohol(2005) `a'_alcohol(2006) `a'_alcohol(2007) `a'_alcohol(2008), ///
	trunit(`x') trperiod(2010) xperiod(1982(1)2008) fig keep(`x'placebo_lags) replace
...
quietly: save donorstate_weights_2010, replace
