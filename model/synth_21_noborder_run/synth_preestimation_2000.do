...
if regexm(c(os),"Mac") == 1 {
	local mypath_share_narrow = "`mypath_nb'/IL 2000 - share - narrow/"
	local mypath_drivers_narrow = "`mypath_nb'/IL 2000 - drivers - narrow/"
...
cd "`mypath_nb'"
log using "`mypath_logs'synth_alcohol_preestimation_nb_21plus_2000", replace
...
tabstat `vars' if year < 1999  & year>1991, statistics(mean) by(statename)
...
graph bar (mean) `x'0 `x'1 if year < 1999  & year>1991, ///
...
xtline `depvar'_alcohol if state == 0 & year>1991 | state == 17 & year>1991, i(statename) t(year)  overlay ///
	title ("Share of Accidents Due to Alcohol, US and IL (1992-2015)")			///
	ytitle("Share of Accidents Due to Alcohol") xsize(8) 
graph export "Alcoholshare_line_2015.pdf", as(pdf) replace

xtline `depvar'_alcohol if state == 0 & year < 1999 & year>1991 | state == 17 & year < 1999 & year>1991, i(statename) t(year)  overlay 	///
	title ("Share of Accidents Due to Alcohol, US and IL (1992-1999)") 							///
	ytitle("Share of Accidents Due to Alcohol") xsize(8) 
